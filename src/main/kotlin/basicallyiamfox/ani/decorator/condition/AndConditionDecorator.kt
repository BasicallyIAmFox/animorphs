...
class AndConditionDecorator() : ConditionDecorator() {
    object Serializer : ISerializer<AndConditionDecorator> {
        override fun toJson(obj: JsonObject, type: AndConditionDecorator) {
        ...
        override fun fromJson(obj: JsonObject): AndConditionDecorator {
        ...
        override fun toPacket(buf: PacketByteBuf, type: AndConditionDecorator) {
        ...
        override fun fromPacket(buf: PacketByteBuf): AndConditionDecorator {
            val inst = AndConditionDecorator()
